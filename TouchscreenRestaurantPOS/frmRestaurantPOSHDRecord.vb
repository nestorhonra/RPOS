...
Public Class frmRestaurantPOSHDRecord
    ...
    Public Sub GetData()
        Try
            ...
            con.Open()
            Dim sql As String = "Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,RTRIM(DiscountReason),(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID  order by BillDate"
